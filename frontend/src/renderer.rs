...
pub const DIMS: window::Extent2D = window::Extent2D { width: 1024, height: 700 };
#[cfg_attr(rustfmt, rustfmt_skip)]
const QUAD: [Vertex; 6] = [
    Vertex { a_Pos: [ -1.25, 1.25 ], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  1.25, 1.25 ], a_Uv: [1.0, 1.0] },
    Vertex { a_Pos: [  1.25,-1.25 ], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -1.25, 1.25 ], a_Uv: [0.0, 1.0] },
    Vertex { a_Pos: [  1.25,-1.25 ], a_Uv: [1.0, 0.0] },
    Vertex { a_Pos: [ -1.25,-1.25 ], a_Uv: [0.0, 0.0] },
];
