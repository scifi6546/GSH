...
pub trait Scene{
    fn request_models(&self)->(Vec<Model>,Vec<Texture>, Box<dyn Fn(Vec<ModelId>,Vec<TextureId>)->Self>);  
...
impl Scene for BoxScene{
    fn request_models(&self)->(Vec<Model>,Vec<Texture>, Box<dyn Fn(Vec<ModelId>,Vec<TextureId>)->Self>){
        ...
        (vec![model],vec![Texture{}],Box::new(|model,textures|{BoxScene{
...
impl Engine{
    pub fn new()->(Vec<Model>,Vec<Texture>,Box< dyn Fn(Vec<ModelId>,Vec<TextureId>)->Engine>){
    unimplemented!()
    }
